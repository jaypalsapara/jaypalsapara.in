        ...
        {cover && (
          <div className="min-h-0 overflow-hidden self-stretch justify-self-stretch">
            <ClientCldImage
              ...
              src={cover}
              alt={cover}
              className="size-full -z-1 group-active/next:scale-[1.01] group-hover/next:scale-[1.01] scale-103 transition-[scale,filter] duration-300 will-change-[scale,filter] ease-in-out brightness-100 group-hover/next:brightness-78 group-active/next:brightness-78 object-cover"
            />
          </div>
        )}
