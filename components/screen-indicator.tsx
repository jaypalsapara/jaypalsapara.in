export default function ScreenIndicator() {
  return (
    <div className="fixed bottom-0 right-0 z-9999999999999 m-3 flex items-center justify-center overflow-hidden rounded-md border border-neutral-600 bg-black px-1.5 text-sm text-white opacity-30 select-none *:hidden hover:opacity-100">
