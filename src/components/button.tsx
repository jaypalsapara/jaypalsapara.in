...
const buttonVariants = cva('cursor-pointer border-transparent transition-colors border inline-flex justify-center items-center gap-2 rounded-xs', {
  variants: {
    ...
    size: {
      default: ' px-4 py-2 text-base lg:text-sm font-medium has-[svg]:px-3 [&_svg]:size-4',
      small: 'px-2 py-1 text-base lg:text-sm has-[svg]:px-2 [&_svg]:size-4',
      tiny: 'px-1.5 py-0.5 text-sm lg:text-xs tracking-wide [&_svg]:size-3',
    },
  },
  defaultVariants: {
    variant: 'default',
