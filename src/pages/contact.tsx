...
export default function Contact() {
  return (
    <Wrapper className="pb-14 lg:pb-18">
      <h1 className="col-span-full mt-14 text-pretty lg:mt-16">
      ...
      <div className="col-span-full mt-14 grid grid-cols-subgrid space-y-24 lg:mt-18">
        <div className="col-span-4 space-y-12 *:flex *:flex-col *:gap-2 lg:col-span-6">
          <div>
            ...
            <div className="flex flex-col gap-4">
              {SocialLinks.map((social) => (
                <a
                  ...
                  className="group max-w-fit text-lg hover:underline"
